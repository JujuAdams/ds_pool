...
var _instance = ds_pool_find_value( _pool, _index );
...
if ( _instance != undefined )
{
    ...
    show_debug_message( "ds_pool_instance_activate_layer - Instance popped from pool (" + string( _instance ) + ") didn't exist. Creating a new instance" );
